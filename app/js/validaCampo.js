...
function validacao(){ 
//Página de Cadastro
	if(document.cadastroUsu.usuario.value=="" || document.cadastroUsu.senha.value=="" || document.cadastroUsu.ano.value==""){
		...
		else if(document.cadastroUsu.ano.value==""){
		document.cadastroUsu.ano.focus();
		return false;
		}
