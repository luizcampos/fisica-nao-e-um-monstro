...
<title>Adicionar admistrador </title>
</head>
<body>
<?php
...
<form name="top" method="post" action="barraPesquisa3.php?pg=1">
...
$select = "SELECT * from usuario ORDER BY id_usu DESC LIMIT $inicio, $qtd ";
	try {
 ...
 <?php echo $mostra->nome_usu;?>
 <a href="adicionaAdm.php?id=<?php echo $mostra->id_usu?>" target="_top" class="botao push" >Vizualizar</a>
