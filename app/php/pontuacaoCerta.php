...
header ('Content-type: text/html; charset=iso-8859-1');
	//VERIFICA SE ELE JA FEZ AQUELA PERGUNTA
$query3 = "SELECT id_pon FROM pontuacao WHERE Sub_Materia_id_sub_fk='1' and usuarios_id_usu='$idUsu' and perguntas_exercicios_id_perg ='$idPer'";
		...
		else if ($alter==0)
		{
			...
			$insert = "INSERT INTO pontuacao(perguntas_exercicios_id_perg,usuarios_id_usu,pontos_pon,Sub_Materia_id_sub_fk	) VALUES('$idPer','$idUsu','1','1')";
         ...
         //SE ELE TIVER - de 4 PONTOS
		else
		{
				//echo "Você ainda não tem 5 pontos";
		}
		}catch(PDOException $e){
				echo 'Erro '.$e->getMessage();
