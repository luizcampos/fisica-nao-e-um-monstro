...
if (!is_numeric($pg)){echo '<script language= "JavaScript">
				location.href="ver-minhas-respostas.php?pg=1";
				</script>';}
...
and usuario.nome_usu='$usuariowva' ORDER BY id_per  DESC LIMIT $inicio, $qtd ";
	try {
...
<div class="tabela">
  <table class="tab">
    <tr class="borda2">
      <th colspan="6"> <img src="imagem/Icone/question (2).png" />Perguntas respondidas por mim.</th>
    </tr>
    <tr >
...
$sql = "SELECT * FROM perguntas_forum,respostas_forum,usuario
WHERE usuario.id_usu=respostas_forum.id_usu_fk 
and perguntas_forum.id_per=respostas_forum.perguntas_forum_id_per 
and usuario.nome_usu='$usuariowva' ORDER BY id_per  DESC LIMIT $inicio, $qtd";
	try {
 ...
 ?>
<!--abre paginas-->
<div class="paginas" id="paginas" > <a href="ver-minhas-respostas.php?pg=1" >&laquo;Inicio</a>
<?php
  if(isset($_GET['pg'])){
	  $numPag = $_GET['pg'];
	  }
...
?>
     <a href="ver-minhas-respostas.php?pg=<?php echo $i?>" class="ativo<?php echo $i; ?>"><?php echo $i;?></a>     
...
?>
<a href="ver-minhas-respostas.php?pg=<?php echo $paginas;?>" >Final&raquo;</a> 
