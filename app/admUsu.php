...
<input  type="text" class="txts bradius" name="pesquisa" value="" placeholder="pesquise o usuário que deseja encontrar aqui."/>
<input type="submit" id ="pesquise" class="btnPesquisar grow" name="pesquise"  value="Pesquisar"/>
		...
		<div class="contenedor3 push" id="dos" title="bloquear/desbloquear um usuário que desrespeitou as normas do fórum">
			<img class="icon2" src="imagem/Icone/blocked5.png"  align="left">
			<p class="texto2">bloquear/desbloquear usuários</p>
		</div>

		<div class="contenedor3 push" id="tres1" title="remover definitivamente um usuário">
