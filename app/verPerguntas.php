...
$select = "SELECT * from perguntas_forum,usuario where usuario.id_usu=perguntas_forum.user_per ORDER BY id_per DESC LIMIT $inicio, $qtd ";
	try {
...
<?php
 ...
 ?>
<!--abre paginas-->
<div class="paginas" id="paginas" > <a href="verPerguntas.php?pg=1" >&laquo;Inicio</a>
<?php
  if(isset($_GET['pg'])){
	  $numPag = $_GET['pg'];
	  }
...
?>
     <a href="verPerguntas.php?pg=<?php echo $i?>" class="ativo<?php echo $i; ?>"><?php echo $i;?></a>     
...
?>
<a href="verPerguntas.php?pg=<?php echo $paginas;?>" >Final&raquo;</a> 
</div>
