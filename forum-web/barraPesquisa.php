...
$qtd = 5;
$inicio = ($pg*$qtd) - $qtd; 
$pesquise=utf8_decode(trim(strip_tags($_POST['pesquisa'])));

$select = "SELECT * FROM perguntas_forum where titulo_per LIKE '%$pesquise%' or conteudo_per LIKE '%$pesquise%'";
try {
...
<div class="tabela">
  <table>
    <tr class="borda2">
      <th colspan="3"><img src="imagem/Icone/search (2).png" /><?php echo " ".$conta." ".$r." ";?></th>
</tr>
    <?php 
