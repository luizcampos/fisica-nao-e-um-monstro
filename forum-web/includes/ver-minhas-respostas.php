...
if (!is_numeric($pg)){echo '<script language= "JavaScript">
				location.href="verPerguntas.php?pg=1";
				</script>';}
...
$select = "SELECT * from respostas_forum,usuario usuario where  usuario.id_usu=respostas_forum.id_usu_fk   and usuario.nome_usu = '$usuariowva' ORDER BY id_per DESC LIMIT $inicio, $qtd ";
	try {
...
<div class="acomodar">
  <table class="tab">
    <tr class="borda2">
      <th colspan="6"> <img src="imagem/Icone/question (2).png" />Minhas respostas</th>
    </tr>
    <tr >
...
<?php
 ...
 $sql= "SELECT * from respostas_forum,usuario usuario where  usuario.id_usu=respostas_forum.id_usu_fk  and usuario.nome_usu = '$usuariowva' ";
	try {
